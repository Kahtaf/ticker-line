...
| ---------- | ------------ | ------------------------------------------------------------------------------- |
| Apple      | `AAPL`       | [Open SVG](https://ticker-line.com/v1/sparkline?ticker=AAPL&timeframe=1m)       |
| Bitcoin    | `BTC/USD`    | [Open SVG](https://ticker-line.com/v1/sparkline?ticker=BTC%2FUSD&timeframe=1m)  |
| S&P 500    | `SPY`        | [Open SVG](https://ticker-line.com/v1/sparkline?ticker=SPY&timeframe=1m)        |
| Nasdaq 100 | `NAS100-USD` | [Open SVG](https://ticker-line.com/v1/sparkline?ticker=NAS100-USD&timeframe=1m) |
| Gold       | `XAU/USD`    | [Open SVG](https://ticker-line.com/v1/sparkline?ticker=XAU%2FUSD&timeframe=1m)  |
| USD / CAD  | `USD/CAD`    | [Open SVG](https://ticker-line.com/v1/sparkline?ticker=USD%2FCAD&timeframe=1m)  |
